      ...
      <div className="container mx-auto flex flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between md:px-6">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <p className="flex flex-wrap items-center gap-x-2 text-[11px] font-bold tracking-widest text-red-100 uppercase">
              Active emergency
              {activeIncident.declaredAt && (
                <span className="font-semibold tracking-normal text-red-200 normal-case">
                  · since {activeIncident.declaredAt}
                </span>
              )}
            </p>
            <p className="mt-0.5 text-base leading-tight font-extrabold sm:text-lg">
              {activeIncident.title}
            </p>
            <p className="mt-0.5 line-clamp-2 text-sm text-red-50/90">
