                  ...
                  <div className="mb-6 flex flex-col items-center justify-between gap-4 border-b border-slate-100 pb-6 sm:flex-row">
                    ...
                    <div className="flex w-full gap-2 sm:w-auto">
                      <button
                        ...
                        className={`flex-1 rounded-xl border px-4 py-2 text-sm font-bold transition-all sm:flex-none ${
                          route === "CDO-Iligan"
                        ...
                        {getCdoIliganData().map((trip, idx) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div
                                className={`mt-1 rounded px-2 py-0.5 text-[10px] font-bold tracking-wider uppercase ${
                                  isPast
                      ...
                      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {getCdoMarawiData().map((trip, idx) => {
                          ...
                          return (
                            <div
                              key={idx}
                              className={`flex items-center justify-between rounded-2xl border p-6 shadow-sm transition-all ${
                                isPast
                                  ? "border-slate-200 bg-slate-50 opacity-60 grayscale"
