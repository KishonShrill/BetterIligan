...
export default function JeepneyMapControls({
  mapRef,
}: {
  ...
  return (
    <div className="pointer-events-auto absolute right-3 bottom-3 z-[1000] flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl sm:bottom-11">
      <button
        type="button"
