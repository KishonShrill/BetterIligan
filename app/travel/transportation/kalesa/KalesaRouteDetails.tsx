...
import type { KalesaFare, KalesaCodeEntry } from "./type";

interface KalesaRouteDetailsProps {
  route: {
    routeId: string;
    name: string;
    routeColor?: string;
...
export default function KalesaRouteDetails({
  route,
  codeEntry,
  getRouteColor,
  onClose,
}: KalesaRouteDetailsProps) {
