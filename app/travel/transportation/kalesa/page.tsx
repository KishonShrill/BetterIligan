...
export const metadata: Metadata = {
    title: "Kalesa Routes",
    description: "Interactive map of Iligan City kalesa routes and transportation guides.",
};
        ...
        <main className="min-h-screen bg-slate-50 font-sans pb-24">
            <SubpageHero>
                ...
                <SubpageHero.Description>
                    Find your way around Iligan City with our community kalesa route guide and always know the right fare
                </SubpageHero.Description>
            </SubpageHero>
