...
export default async function AdminPage() {
  ...
  const [pending, approved, unverified, active, incidentState] =
    await Promise.all([
      getPendingBoardMessages(),
      getApprovedBoardMessages(),
      getUnverifiedIncidents(),
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="container mx-auto flex items-center gap-4 px-4 py-4 md:px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-900 px-3 py-1 text-[11px] font-bold tracking-wider text-white uppercase">
              ...
              {unverified.map((r) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center rounded-full border border-orange-100 bg-orange-50 px-2 py-0.5 text-[10px] font-bold tracking-wide text-orange-700 uppercase">
