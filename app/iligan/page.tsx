...
export const metadata: Metadata = {
  ...
  description:
    "Browse essential information about Iligan City, from local profiles and officials to barangays and public services.",
};
    ...
    <main className="min-h-screen bg-slate-50 pb-24 font-sans">
      ...
      <SubpageHero>
        ...
        <SubpageHero.Description>
          Browse essential information about Iligan City, from local profiles
          and officials to barangays and public services, all in one place.
        </SubpageHero.Description>
      </SubpageHero>
