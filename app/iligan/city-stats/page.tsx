...
export const metadata: Metadata = {
  ...
  description:
    "Explore official statistics, demographics, infrastructure, and economic data for Iligan City, the City of Majestic Waterfalls.",
};
...
export default function CityStatsPage() {
  ...
  const jsonLd = {
    ...
    description:
      "Official city profile, demographics, and statistics for Iligan City, Philippines.",
