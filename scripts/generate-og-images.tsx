...
async function generateImages() {
    ...
    const outDir = path.join(process.cwd(), 'public', 'images', 'opengraph-image');
    ...
    const boldFontPath = path.join(process.cwd(), 'public', 'fonts', 'Inter', 'Inter_28pt-ExtraBold.ttf');
    const semiBoldFontPath = path.join(process.cwd(), 'public', 'fonts', 'Inter', 'Inter_24pt-SemiBold.ttf');
    ...
    console.log(`Starting OG Image Generation... (Force: ${isForce}, Check: ${isCheck})`);
    ...
    if (isCheck && newlyGeneratedCount > 0) {
        ...
        console.error(`Please commit the newly generated images in /public/images/opengraph-image/ before pushing.`);
