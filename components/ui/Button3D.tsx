...
export default function Button3D({
  ...
  const renderIcon = IconComponent ? (
    <IconComponent
      className={`transition-transform ${hoverTranslateClass} ${iconSizeClass}`}
    />
  ) : hasArrow ? (
    <ArrowRight
      className={`transition-transform group-hover:translate-x-1 ${hoverTranslateClass} ${iconSizeClass}`}
    />
  ) : null;
