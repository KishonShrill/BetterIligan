...
// 1. Define a base interface with the properties needed by the UI
...
// 2. Use a Generic Type <T> so it accepts any route type that extends BaseRoute
interface MobileRouteSelectorProps<T extends BaseRoute> {
  routes: T[];
...
export default function MobileRouteSelector<T extends BaseRoute>({
  routes,
  activeRouteId,
  setActiveRouteId,
  showAllRoutes,
